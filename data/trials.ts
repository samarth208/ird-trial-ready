...
export const CURATED_TRIALS: CuratedTrial[] = [
  ...
  {
    nctId: "NCT05874310",
    title: "FT-002 gene therapy for RPGR-associated X-linked retinitis pigmentosa (Phase 1/2)",
    conditionGroup: "RP",
    geneSpecific: true,
    verified: false,
    example: false,
    travelSupport: "unknown",
    sourceUrl: "https://clinicaltrials.gov/study/NCT05874310",
    therapyType: "AAV gene therapy (subretinal injection)",
    ...commonExtras,
    curation: transcribed,
    requirements: [
      { id: "gene", type: "gene", label: "Confirmed RPGR mutation (X-linked RP)", acceptedGenes: ["RPGR"], canSelfReport: true, sourceSection: "inclusion", sourceText: "Genetically confirmed X-linked retinitis pigmentosa caused by a mutation in the RPGR gene." },
      { id: "sex", type: "sex", label: "Male", requiredSex: "male", canSelfReport: true, sourceSection: "inclusion", sourceText: "Participants must be male." },
      { id: "age", type: "age", label: "Age 8–45 years", minimum: 8, maximum: 45, canSelfReport: true, sourceSection: "inclusion", sourceText: "Participants must be between 8 and 45 years of age." },
      { id: "residual_function", type: "clinical_confirmation", label: "Sufficient residual retinal structure/function", canSelfReport: false, sourceSection: "inclusion", sourceText: "Sufficient residual retinal structure and function, assessed at the study site." },
      { id: "no_prior_gt", type: "prior_treatment", label: "No previous ocular gene therapy", excludedTreatments: ["gene_therapy"], canSelfReport: true, sourceSection: "exclusion", sourceText: "Prior ocular gene therapy is an exclusion criterion." },
    ],
  },
];
